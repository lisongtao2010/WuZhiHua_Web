...
Public Class Com
    ...
    Public Shared Function IsNullOne(ByVal v As Object) As String
    ...
    '类型Scan Or Input
    Public Shared Function GetTextBoxClass(ByVal key As String) As String
        If key = "扫码" Then
            Return "textbox_scan"
        Else
    ...
    Public Shared Function GetTextBoxEnable(ByVal key As String, Optional ByVal ShiCeKbn As String = "1") As String
        Select Case key
            Case "00" '目测
                Return "none"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function GetPicInfo(ByVal pictureId As String) As Byte()
        Dim CheckDA As New CheckDA
        Dim bt As Byte()
        Dim dtPicInfo As Data.DataTable = CheckDA.GetPicInfoById(pictureId).Tables("PicInfo")
    ...
    Public Shared Function CheckJizhunzhi(ByVal zbenchmark_type As String, _
        ...
        Try
            ...
            ElseIf (zbenchmark_type = "12") Then
                ...
                Dim temp As String = ("20" + value).Replace("Y7", "").ToUpper()
