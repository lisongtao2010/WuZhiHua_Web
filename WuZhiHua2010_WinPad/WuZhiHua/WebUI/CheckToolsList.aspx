<%@ Page Title="" Language="VB" MasterPageFile="~/Site.Mobile.master" AutoEventWireup="false" CodeFile="CheckToolsList.aspx.vb" Inherits="CheckCunFaMobile" %>
...
<tr>
         <th class="title_th">
            <a>LIXIL</a><br />
            <a class="ver"><%Response.Write(System.Configuration.ConfigurationManager.AppSettings("ver").ToString)%></a>
        </th>
