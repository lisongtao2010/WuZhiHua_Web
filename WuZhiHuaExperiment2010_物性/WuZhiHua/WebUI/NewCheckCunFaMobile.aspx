...
<asp:Content ID="C1" ContentPlaceHolderID="FC" runat="Server">
    ...
    <div id="AutoIptStaus" style="position: absolute; display: none; width: 700px; height: 400px; z-index: 100000; font-size: 50px; text-align: center; vertical-align: middle; margin: 15% auto 30% auto; background-color: #fff; border: 3px solid #ccc;">
        试验结果等待
        <hr />
        <a id="AutoIptStausTxt"></a>
        <input type="button" value="取消" style="font-size: 80px; height: 100px; width: 200px" onclick="$('#AutoIptStaus').hide(); IsShowAutoIpt = false;" />
    </div>
    <%--Title--%>
    ...
    <div class="div_ms_new" style="overflow: hidden; margin-bottom: 0px;">
        <table cellspacing="0" border="1" class="tbl_ms_title_new"
            style="width: 1286px; border-collapse: collapse; font-size: 24px; font-weight: bold; text-align: center; border-color: #fff;">
            <tr>
                <%--
<td  style="width:140px;">
...
<td  style="width:80px;">方法</td>--%>
                <td style="width: 100px;">
                    <asp:Label ID="Label1" runat="server" Text="上"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label2" runat="server" Text="中"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label3" runat="server" Text="下"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label4" runat="server" Text="上"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label5" runat="server" Text="中"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label6" runat="server" Text="下"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label7" runat="server" Text="平均"></asp:Label></td>
                <td style="width: 100px;">
                    <asp:Label ID="Label8" runat="server" Text="最小"></asp:Label></td>
        ...
        <table>
            <tr>
                ...
                <td style="text-align: left; vertical-align: top;">
                    <table cellspacing="0"
                        border="1"
                        style="width: 400px; border-collapse: collapse; font-size: 24px; font-weight: bold; border-color: #eee; background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #4499ee), color-stop(1, #065fb9)); color: #fff; text-align: center;">
