...
Public Class ResultDA
    ...
    Public Function InsertResultDetail(ByVal result_id As String, ByVal where_result_id As String) As Integer
        ...
        With sb
            ...
            .AppendLine(" , measure_value4")
            .AppendLine(" ,measure_value5")
            .AppendLine(" , measure_value6")
    ...
    Public Function Updatet_check_result_continue_chk_flg(ByVal id As String, ByVal continue_chk_flg As String, Optional ByVal result As String = "") As Integer
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function InsertResultDetailWaiguan(ByVal crIndex As String, ByVal goods_cd As String) As Integer
        ...
        With sb
            ...
            For i As Integer = 1 To 9
                ...
                .AppendLine("                '' AS measure_value3,")
                .AppendLine("                '' AS measure_value4,")
                .AppendLine("                '' AS measure_value5,")
                .AppendLine("                '' AS measure_value6,")
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function UpdateResultDetail(ByVal result_id As String, ByVal check_id As String, ByVal dis_no As String, ByVal check_times As String, ByVal measure_value1 As String, ByVal measure_value2 As String, ByVal measure_value3 As String, ByVal measure_value4 As String, ByVal measure_value5 As String, ByVal measure_value6 As String, ByVal result As String, ByVal remarks As String, ByVal benchmark_type As String, ByVal benchmark_value1 As String, ByVal benchmark_value2 As String, ByVal benchmark_value3 As String, ByVal usercd As String) As Integer
        ...
        sb.AppendLine(" , measure_value3 = @measure_value3  ")
        paramList.Add(MakeParam("@measure_value3", SqlDbType.VarChar, 100, measure_value3))


        sb.AppendLine(" , measure_value4 = @measure_value4 ")
        paramList.Add(MakeParam("@measure_value4", SqlDbType.VarChar, 100, measure_value4))
        sb.AppendLine(" , measure_value5 = @measure_value5  ")
        paramList.Add(MakeParam("@measure_value5", SqlDbType.VarChar, 100, measure_value5))


        sb.AppendLine(" , measure_value6 = @measure_value6 ")
        paramList.Add(MakeParam("@measure_value6", SqlDbType.VarChar, 100, measure_value6))
        ...
        paramList.Add(MakeParam("@checkUserCd", SqlDbType.VarChar, 200, usercd))
        '更新の実行
    ...
    Public Function ins_t_dlx_chk(ByVal id As String, ByVal department_cd As String, ByVal line_name As String, ByVal xingfan As String, ByVal chk_kbn As String) As Integer
        ...
        '非继续检查情况下的最终保存
        sb.AppendLine(" INSERT INTO  t_dlx_chk")
