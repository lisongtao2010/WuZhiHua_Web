...
Public Class CheckDA
    ...
    Public Function GetNgMS(ByVal strGoodsCode As String) As DataTable
        ...
        sb.AppendLine(" ,E.check_way AS '方法'")
    ...
    Public Function GetChkDetailInfo(ByVal result_id As String, ByVal goods_cd As String, ByVal kind_cd As String, ByVal classify_id As String, ByVal tools_id As String) As DataTable
        ...
        sb.AppendLine(" , ISNULL(t_result_detail.measure_value3, '') AS measure_value3 ")
        sb.AppendLine(" , ISNULL(t_result_detail.measure_value4, '') AS measure_value4 ")
        sb.AppendLine(" , ISNULL(t_result_detail.measure_value5, '') AS measure_value5 ")

        sb.AppendLine(" , ISNULL(t_result_detail.measure_value6, '') AS measure_value6 ")
