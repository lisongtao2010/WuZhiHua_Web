...
Public Class CheckIndex
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function MakeNewIndex(ByVal typeKbn As String, ByVal userCd As String, ByVal dateNow As String) As String
        ...
        SyncLock "GetIndex"
            ...
            Dim no As String = Now.ToString("yyyyMMdd") & CInt(ds.Tables(0).Rows(0).Item("no").ToString).ToString.PadLeft(5, "0"c)
