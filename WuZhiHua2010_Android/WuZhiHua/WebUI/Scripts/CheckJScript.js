...
function CheckRowInput(e) {
    ...
    if (zbenchmark_type == '00') {//目视
        ...
        // V1+V3 <= IN <= V1+V2
        if (parseFloat(value) >= parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value3) && parseFloat(value) <= parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value2)) {
            Result = true;
        } else {
    ...
    if (zbenchmark_type == '15-2') {
        ...
        // V1+V3 《 ｜V1-V2｜ 《 V1+V3
        if (parseFloat(cha) > parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value3) && parseFloat(cha) < parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value2)) {
            Result = true;
        } else {
           // jizhun = (parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value3)) + "～" + (parseFloat(zbenchmark_value1) + parseFloat(zbenchmark_value2));
            jizhun = "(" + zbenchmark_value1.replace(/-/g, "") + "," + zbenchmark_value2.replace(/-/g, "") + "," + zbenchmark_value3.replace(/-/g, "-") + ")";
