<%@ page title="" language="VB" masterpagefile="~/Site.Mobile.master" autoeventwireup="false" inherits="CheckCunFaMobile, App_Web_ka2laza4" %>
...
<asp:GridView ID="gvZhiju" runat="server" AutoGenerateColumns = "false" Width="100%" style="color:#000;" cssClass="tools_table">
<Columns>
...
<ItemTemplate>
<input type="text" class="textbox_lable" value='<%#Eval("remarks").ToString%>' style="width:260px; text-align:center;" readonly="true" />
</ItemTemplate>
</asp:TemplateField>
