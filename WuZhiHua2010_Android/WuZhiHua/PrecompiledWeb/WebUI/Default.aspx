<%@ page title="" language="VB" masterpagefile="~/Site.Mobile.master" autoeventwireup="false" inherits="_Default, App_Web_ae43r4wm" %>
...
<table cellspacing="0" rules="all" border="0" class="table_title_new">
    <tr>
        ...
        <th style="width:90px;">
            检查员</th>
        <td style="width:140px;">
            <asp:TextBox ID="tbxCheckUserCd" runat="server" CssClass="defaultPage_textbox_scan" Text = "" Width="140" AutoCompleteType="None"></asp:TextBox>
        </td>
        <th style="">
